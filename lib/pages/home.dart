...
class HomePage extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildCategoryItem('Snacks', 'https://tse3.mm.bing.net/th?id=OIP.l9oe3pbUBIlVznzWEIktcwHaFc&pid=Api&P=0&h=180'),
                  _buildCategoryItem('Xerox', 'https://atzone.in/wp-content/uploads/2017/11/XeroxShop.jpg'),
                  _buildCategoryItem('Stationaries', 'https://tse1.mm.bing.net/th?id=OIP.BQTt5vaPXomBjewK-99-uQHaEv&pid=Api&P=0&h=180'),
                ],
              ),
              const SizedBox(height: 20),
 ...
 Widget _buildProductCard(int index) {
  // Online images for the best-selling products
  ...
  // Descriptions for the best-selling products
            ...
            Center(
              child: Image.network(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return const Icon(Icons.broken_image, size: 80); // Fallback in case of loading error
                },
              ),
            ),
          ],
